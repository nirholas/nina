...
description: Core blockchain interaction tools for EVM, Solana, and  chains
---

# Blockchain Tools

Fundamental blockchain interaction tools providing read/write access to  blockchains including Ethereum, Solana, BNB Chain, Arbitrum, and more.
