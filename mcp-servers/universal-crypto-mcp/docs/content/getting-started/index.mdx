...
description: Install and configure the most extensive crypto MCP server -  networks, 380+ tools, DeFi, CEX, x402 payments
...
Welcome to **Universal Crypto MCP** - the most comprehensive cryptocurrency MCP server that enables AI agents (Claude, ChatGPT, Cursor) to interact with  blockchain networks through natural language.
...
- ✅ ** Blockchain Networks** - Ethereum, Arbitrum, Polygon, Base, Optimism, Solana, and more
...
### Multi-Chain Support
Access  EVM and non-EVM chains from a single MCP server:
